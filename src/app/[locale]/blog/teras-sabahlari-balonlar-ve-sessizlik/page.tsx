...
export default async function BlogPostPage({ params }: PageProps) {
  ...
  const metadata = {
    tr: { title: 'Teras Sabahları: Balonlar ve Sessizlik', author: 'Anitya Cave House' },
    en: { title: 'Terrace Mornings: Balloons and Silence', author: 'Anitya Cave House' },
    zh: { title: '露台的早晨：气球与寂静', author: 'Anitya Cave House' },
  };
